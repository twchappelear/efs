...
def portfolio(request,pk):
   ...
   sum_results_by_mutualfund = 0
   sum_of_initial_mutualfund_value = 0



   for mutualfund in mutualfunds:
       sum_results_by_mutualfund += mutualfund.results_by_mutualfund()
       sum_of_initial_mutualfund_value += mutualfund.initial_mutualfund_value()
   ...
   return render(request, 'portfolio/portfolio.html', {'customers': customers, 'investments': investments,
                                                       ...
                                                       'sum_of_initial_mutualfund_value': sum_of_initial_mutualfund_value,
                                                       'sum_of_results_by_mutualfund': sum_results_by_mutualfund,})
